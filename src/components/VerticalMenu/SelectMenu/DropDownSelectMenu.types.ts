...
/**
 * Props for the DropDownSelectMenu component.
 * A dropdown variant of SelectMenu that combines trigger and selection menu content.
 */
export interface DropDownSelectMenuProps {
